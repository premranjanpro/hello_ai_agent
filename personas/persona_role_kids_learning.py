    ...
    def __init__(self):
        super().__init__(
            ...
            base_prompt=(
                ...
                "- Whenever child asks to see an animal or photo (e.g. 'hathi dekhna hai', 'sher dikhao', 'photo dikhao', 'tasveer dikhao', 'billi dikhao', 'photo open karo'), OR when discussing animals:\n"
                "  * YOU MUST IMMEDIATELY CALL `start_visual_image_quiz(topic='elephant')` (or 'lion', 'dog', 'cat', 'tiger', 'horse', 'cow', 'monkey', 'rabbit', 'peacock', 'duck', 'apple', 'mango') to open the HD photo in the bottom sheet!\n"
                "  * NEVER just talk or describe the animal in words without calling `start_visual_image_quiz`!\n"
                ...
                "  'Arey wah! Dekho screen par photo aa gayi! Pehchano kaun? Is tasveer mein kaun sa janwar hai? Bolke batao ya screen par touch karo!' NEVER stay silent when the image opens!\n"
